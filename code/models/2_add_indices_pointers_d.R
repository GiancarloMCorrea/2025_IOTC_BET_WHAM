...
# LL selex two blocks, LL and PSLS CPUE index ------------------------------
...
input_selex = list(model = c('len-double-normal', 
                             ...
                             'len-logistic',
                             'len-logistic'),
                   initial_pars = list(c(113, -1.33, 6, 6.55, -5, -1.1),
                                       c(0.001, 0.34, 0.2, 0.42, 0.23), 
                                       c(38, -3, 0, 6.7, 7, -5),
                                       c(105, 10),
                                       c(57, 6),
                                       c(95, 7.7)),
                   fix_pars = list(c(3,4,5), c(1,3), c(3,5,6), NULL, 2, NULL),
                   n_selblocks = 6)
